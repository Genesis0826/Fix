...
-- Order: Run THIRD - stores Pillar CV parsing results per application
...
CREATE TABLE IF NOT EXISTS extracted_cv_skills (
  ...
  extracted_from VARCHAR(20) DEFAULT 'cv_text' CHECK (extracted_from IN ('cv_text', 'job_description')),
